...
const Dashboard = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Dashboard - Online Trading Platform</title>
                <meta
                    name="description"
                    content="View your Online Trading Platform dashboard with real-time currency pair quotes and account information."
                />
            </Helmet>
